...
public class androidTest {
    ...
    public WebElement selectUsingAccessibility(AndroidDriver driver, String location) {
        return driver.findElement(AppiumBy.accessibilityId(location));
    }
    public WebElement selectUsingXpath(AndroidDriver driver, String location) {
    ...
    public void androidLaunchTest() throws MalformedURLException, InterruptedException {
        ...
        //opening menu
        selectUsingAccessibility(driver, "open menu").click();
        //clicking log in
        selectUsingXpath(driver,"//android.view.ViewGroup[@content-desc=\"menu item log in\"]").click();
